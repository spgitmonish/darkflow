...
flow --model cfg/v1/yolo-new.cfg

# 3. It is useful to reuse the first identical layers of tiny for `yolo-new`
flow --model cfg/v1/yolo-new.cfg --load bin/yolo-tiny.weights
...
flow --imgdir sample_img/ --model cfg/v1/yolo-tiny.cfg --load bin/yolo-tiny.weights --gpu 1.0
```
...
flow --imgdir sample_img/ --model cfg/v1/yolo-tiny.cfg --load bin/yolo-tiny.weights --json
```
JSON output:
```json
